...
import video from '../video/student-eyegaze.webm';
import { useState, useEffect } from 'react';

function StudentScenarios(props) {
    ...
    return (
        <div className={`scenarios-page slide-up-page ${props.animation}`} style={{display: props.display}}>
            ...
            <div className="scenarios">
                <div className={false ? "scenario1 faded" : "scenario1"} onMouseEnter={() => setDepression(true)} onMouseLeave={() => setDepression(false)} onClick={() => props.selectScenario('student-depression')}>
                    <h2>Depression</h2>
