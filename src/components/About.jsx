...
function About(props) {
    ...
    return (
        <div className={`about ${props.translate}`} style={{display: props.display}}>
            ...
            <h2>
                The goal of this tool is to familiarize you with having conversations revolving around complex mental health problems 
            ...
            <ul>
                ...
                <li>Providing insights and access to research statistics </li>
                <li>Encouraging healthy and supportive conversation using techniques commonly taught in professional training seminars</li>
            </ul>
