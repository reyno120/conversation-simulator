...
function FriendDepression(props) {
        ...
        return (
            <div className="dialogue blue-background" key={step}>
                ...
                <div className="dialogue-options">
                    <p ref={option1} onMouseEnter={() => setOptionAlt(1, true)} onMouseLeave={() => setOptionAlt(1, false)} onClick={() => {setStep(1);}}>
                        [ Click to continue ]
                    </p>
                </div>
            </div>
        ...
        return (
            <div className="dialogue blue-background" key={step}>
                ...
                <div className="dialogue-options fade-in-longer" key={step}>
                    <p ref={option1} onMouseEnter={() => setOptionAlt(1, true)} onMouseLeave={() => setOptionAlt(1, false)} onClick={() => {setStep(3); setLastStep(1); setLastOption(1);}}>
        ...
        return (
            <div className="dialogue blue-white-background" key={step}>
                ...
                <div className="dialogue-options fade-in-longer">
                    <p ref={option1} onMouseEnter={() => setOption(1, true)} onMouseLeave={() => setOption(1, false)} onClick={() => {setOpen(state => ({...state, two1: true})); setLastOption(1);}}>
                        "I think I might end up needing help, but I don't want to burden others with my problem."
                    </p>
                    <p ref={option2} onMouseEnter={() => setOption(2, true)} onMouseLeave={() => setOption(2, false)} onClick={() => {setStep(3); setLastOption(2);}}>
                    ...
                    <p ref={option3} onMouseEnter={() => setOption(3, true)} onMouseLeave={() => setOption(3, false)} onClick={() => {setOpen(state => ({...state, two2: true})); setLastOption(3);}}>
    ...
    function step3() {
        ...
        return (
            <div className="dialogue blue-white-background" key={step}>
                ...
                <div className="dialogue-options fade-in-longer">
                    <p ref={option1} onMouseEnter={() => setOption(1, true)} onMouseLeave={() => setOption(1, false)} onClick={() => {setOpen(state => ({...state, three1: true})); setLastOption(1);}}>
                        [ Tell about your situation but be vague, leave out who is in the hospital and how much it's been affecting you ]
                    </p>
                    <p ref={option2} onMouseEnter={() => setOption(2, true)} onMouseLeave={() => setOption(2, false)} onClick={() => {setOpen(state => ({...state, three2: true})); setLastOption(2);}}>
                        "I don't want to talk about it."
                    </p>
                    <p ref={option3} onMouseEnter={() => setOption(3, true)} onMouseLeave={() => setOption(3, false)} onClick={() => {setStep(5); setLastStep(3); setLastOption(3);}}>
    ...
    function step4() {
        ...
        return (
            <div className="dialogue blue-white-background" key={step}>
                <h1 className="fade-in">
                    "I know it can be very tough to concentrate on when a family member is in and out of the hospital.
                ...
                <div className="dialogue-options fade-in-longer">
                    ...
                    <p ref={option3} onMouseEnter={() => setOption(3, true)} onMouseLeave={() => setOption(3, false)} onClick={() => {setStep(5); setLastOption(3);}}>
        ...
        return (
            <div className="dialogue blue-white-background" key={step}>
                <h1 className="fade-in">
                    ...
                    Have you talked to your professors about any of this?"
                </h1>
                ...
                <div className="dialogue-options fade-in-longer">
                    <p ref={option1} onMouseEnter={() => setOption(1, true)} onMouseLeave={() => setOption(1, false)} onClick={() => {setStep(7); setLastOption(1);}}>
                    ...
                    <p ref={option3} onMouseEnter={() => setOption(3, true)} onMouseLeave={() => setOption(3, false)} onClick={() => {setOpen(state => ({...state, five1: true})); setLastOption(3);}}>
