...
function FriendDepression(props) {
        ...
        return (
            <div className="dialogue blue-white-background" key={step}>
                ...
                <div className="dialogue-options fade-in-longer">
                    ...
                    <p ref={option2} onMouseEnter={() => setOption(2, true)} onMouseLeave={() => setOption(2, false)} onClick={() => {setStep(4); setVideoPlayed(false); setLastOption(2);}}>
        ...
        return (
            <div className="dialogue blue-white-background" key={step}>
                ...
                <div className="dialogue-options fade-in-longer">
                    ...
                    <p ref={option3} onMouseEnter={() => setOption(3, true)} onMouseLeave={() => setOption(3, false)} onClick={() => {setStep(6); setVideoPlayed(false); setLastOption(3);}}>
    ...
    function step5() {
        if(!open.five1 && !open.five2 && !videoPlayed) {    // only plays video when dialog is not open
        ...
        return (
            <div className="dialogue blue-white-background" key={step}>
                ...
                <Dialog open={open.five1} disableBackdropClick>    
                    <DialogContent className="popup">
                        ...
                        <div className="click-to-close" onClick={() => {setStep(6); setVideoPlayed(false); setOpen(state => ({...state, five1: false}));}}>
                            <p>[ Click to continue ]</p>
                        </div>
                    </DialogContent>
                </Dialog>
                <Dialog open={open.five2} disableBackdropClick>
                    <DialogContent className="popup">
                        <p>
                            Try Again
                        </p>
    ...
    function step6() {
        if(!open.six1 && !open.six2 && !videoPlayed) { // only plays video when dialog is not open
            setVideoTime(112, 116);
            setVideoPlayed(true);   
        }
        ...
        return (
            <div className="dialogue blue-white-background" key={step}>
                ...
                <div className="dialogue-options fade-in-longer">
                    ...
                    <p ref={option2} onMouseEnter={() => setOption(2, true)} onMouseLeave={() => setOption(2, false)} onClick={() => {setStep(7); setVideoPlayed(false); setLastOption(2);}}>
    ...
    function step7() {
        if(!open.seven1 && !open.seven2 && !videoPlayed) {  // only plays video when dialog is not open
            setVideoTime(120, 123.75);    
            setVideoPlayed(true);
        }
        ...
        return (
            <div className="dialogue blue-white-background" key={step}>
                ...
                <Dialog open={open.seven1} disableBackdropClick>    
                    <DialogContent className="popup">
                        <p>Try Again</p>
                ...
                <Dialog open={open.seven2} disableBackdropClick>    
                    <DialogContent className="popup">
                        ...
                        <div className="click-to-close" onClick={() => {setStep(8); setVideoPlayed(false); setOpen(state => ({...state, seven2: false}));}}>
                            <p>[ Click to continue ]</p>
                        </div>
                    </DialogContent>
                </Dialog>
    ...
    function step8() {
        if(!open.eight1 && !open.eight2 && !videoPlayed) {  // only plays video when dialog is not open
            setVideoTime(33, 38);    
            setVideoPlayed(true);
        }
        ...
        return (
            <div className="dialogue blue-white-background" key={step}>
                ...
                <div className="dialogue-options fade-in-longer">
                    <p ref={option1} onMouseEnter={() => setOption(1, true)} onMouseLeave={() => setOption(1, false)} onClick={() => {setStep(10); setVideoPlayed(false); setLastOption(1);}}>
                ...
                <Dialog open={open.eight1} disableBackdropClick>    
                    <DialogContent className="popup">
                        <p>This is a wrap-around way of asking if he's seen a professional, or if he is self-medicating. Be more direct!</p>
                        <div className="click-to-close" onClick={() => {setStep(9); setVideoPlayed(false); setOpen(state => ({...state, eight1: false}));}}>
                            <p>[ Click to continue ]</p>
                        </div>
                    </DialogContent>
                </Dialog>
                <Dialog open={open.eight2} disableBackdropClick>
                    <DialogContent className="popup">
                        <p>
    ...
    function step9() {  
        if(!open.nine1 && !open.nine2 && !videoPlayed) {    // only plays video when dialog is not open
            setVideoTime(40, 49);    
            setVideoPlayed(true);
        }
        ...
        return (
            <div className="dialogue blue-white-background" key={step}>
                ...
                <Dialog open={open.nine1} disableBackdropClick>    
                    <DialogContent className="popup">
                        <p>
                        ...
                        <div className="click-to-close" onClick={() => {setStep(10); setVideoPlayed(false); setOpen(state => ({...state, nine1: false}));}}>
                            <p>[ Click to continue ]</p>
                        </div>
                    </DialogContent>
                </Dialog>
                <Dialog open={open.nine2} disableBackdropClick>
                    <DialogContent className="popup">
                        <p>Try Again</p>
    ...
    function step10() {
        if(!open.ten1 && !open.ten2 && !videoPlayed) { // only plays video when dialog is not open
        ...
        return (
            <div className="dialogue blue-white-background" key={step}>
                ...
                <div className="dialogue-options fade-in-longer">
                    ...
                    <p ref={option2} onMouseEnter={() => setOption(2, true)} onMouseLeave={() => setOption(2, false)} onClick={() => {setStep(11); setVideoPlayed(false); setLastOption(2);}}>
                ...
                <Dialog open={open.ten1} disableBackdropClick>    
                    <DialogContent className="popup">
                        <p>
                            John is aware that resources do exist, but does not have experience using them.
                        </p>
                        <div className="click-to-close" onClick={() => {setStep(11); setVideoPlayed(false); setOpen(state => ({...state, ten1: false}));}}>
                            <p>[ Click to continue ]</p>
                        </div>
                    </DialogContent>
                </Dialog>
                <Dialog open={open.ten2} disableBackdropClick>
                    <DialogContent className="popup">
                        <p>Try Again</p>
    ...
    function step11() {
        if(!open.eleven1 && !open.eleven2 && !videoPlayed) {    // only plays video when dialog is not open
            setVideoTime(58, 65);    
        }
        ...
        return (
            <div className="dialogue blue-white-background" key={step}>
                ...
                <Dialog open={open.eleven3} disableBackdropClick>
                    <DialogContent className="popup">
                        <p>
                        ...
                        <div className="click-to-close" onClick={() => {setStep(12); setVideoPlayed(false); setOpen(state => ({...state, eleven3: false}));}}>
                            <p>[ Click to continue ]</p>
                        </div>
                    </DialogContent>
                </Dialog>
                <Dialog open={open.eleven1} disableBackdropClick>    
                    <DialogContent className="popup">
                        <p>
                        ...
                        <div className="click-to-close" onClick={() => {setStep(12); setVideoPlayed(false); setOpen(state => ({...state, eleven1: false}));}}>
                            <p>[ Click to continue ]</p>
                        </div>
                    </DialogContent>
                </Dialog>
                <Dialog open={open.eleven2} disableBackdropClick>
                    <DialogContent className="popup">
                        <p>Try Again</p>
    ...
    function step12() {
        if(!open.twelve1 && !open.twelve2 && !videoPlayed) {    // only plays video when dialog is not open
            setVideoTime(66, 73);    
            setVideoPlayed(true);
        }
        ...
        return (
            <div className="dialogue blue-white-background" key={step}>
                ...
                <Dialog open={open.twelve3} disableBackdropClick>    
                    <DialogContent className="popup">
                        <p>
                        ...
                        <div className="click-to-close" onClick={() => {setStep(13); setVideoPlayed(false); setOpen(state => ({...state, twelve1: false}));}}>
                            <p>[ Click to continue ]</p>
                        </div>
                    </DialogContent>
                </Dialog>
                <Dialog open={open.twelve1} disableBackdropClick>    
                    <DialogContent className="popup">
                        <p>
                ...
                <Dialog open={open.twelve2} disableBackdropClick>
                    <DialogContent className="popup">
                        <p>
    ...
    function step14() {
        if(!open.fourteen1 && !open.fourteen2 && !videoPlayed) {    // only plays video when dialog is not open
            setVideoTime(76, 86);    
            setVideoPlayed(true);
        }
        ...
        return (
            <div className="dialogue blue-white-background" key={step}>
                ...
                <div className="dialogue-options fade-in-longer">
                    <p ref={option1} onMouseEnter={() => setOption(1, true)} onMouseLeave={() => setOption(1, false)} onClick={() => {setStep(15); setVideoPlayed(false); setLastOption(1);}}>
                        Counseling and Psychological Services (CAPS)
                    </p>
                ...
                <Dialog open={open.fourteen} disableBackdropClick>    
                    <DialogContent className="popup">
                        <p>
    ...
    function step15() {
        if(!open.fifteen1 && !open.fifteen2 && !videoPlayed) {  // only plays video when dialog is not open
            setVideoTime(88, 93);   
            setVideoPlayed(true); 
        }
        ...
        return (
            <div className="dialogue blue-white-background" key={step}>
                ...
                <div className="dialogue-options fade-in-longer">
                    <p ref={option1} onMouseEnter={() => setOption(1, true)} onMouseLeave={() => setOption(1, false)} onClick={() => {setStep(16); setVideoPlayed(false); setLastOption(1);}}>
                ...
                <Dialog open={open.fifteen1} disableBackdropClick>    
                    <DialogContent className="popup">
                        <p>
                ...
                <Dialog open={open.fifteen2} disableBackdropClick>    
                    <DialogContent className="popup">
                        <p>
    ...
    function step16() {
        ...
        return (
            <div className="dialogue blue-white-background" key={step}>
                ...
                <div className="dialogue-options fade-in-longer">
                    <p ref={option1} onClick={() => {setStep(17); setVideoPlayed(false);}}>
                        [ Click to finish ]
                    </p>
                </div>
